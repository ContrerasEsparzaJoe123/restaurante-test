    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.userInfoSection}>
        <View style={{flexDirection: 'row', marginTop: 15}}>
          ...
          <View style={{marginLeft: 20}}>
            ...
            <Caption style={styles.caption}>Apellido</Caption>
          </View>
        </View>
      </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{color: '#777777', marginLeft: 20}}>Durango</Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="#777777" size={20} />
          <Text style={{color: '#777777', marginLeft: 20}}>618-814-1516</Text>
        </View>
        <View style={styles.row}>
      ...
      <View style={styles.infoBoxWrapper}>
        <View
          ...
          <Title>14</Title>
          <Caption>Restaurates visitados</Caption>
        </View>
        <View style={styles.infoBox}>
          <Title>6</Title>
          <Caption>Favoritos</Caption>
        </View>
      </View>
